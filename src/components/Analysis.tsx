      ...
      <div className="flex justify-center mb-8">
        <div className="inline-flex rounded-lg p-1 bg-purple-900/30 backdrop-blur-sm">
          <button 
            ...
            className={`px-4 py-2 rounded-lg ${activeTab === 'swot' ? 'bg-pink-500/20 text-pink-300' : 'text-gray-400 hover:text-white'} font-medium transition-colors`}
          >
            SWOT
          </button>
          <button 
            onClick={() => setActiveTab('pestel')}
            className={`px-4 py-2 rounded-lg ${activeTab === 'pestel' ? 'bg-pink-500/20 text-pink-300' : 'text-gray-400 hover:text-white'} font-medium transition-colors`}
          >
            PESTEL
          </button>
        </div>
      ...
      <div className="w-full">
        {activeTab === 'swot' && (
          <div className="flex flex-col space-y-6">
            <div className="bg-[#2a1e42] backdrop-blur-md p-6 rounded-2xl border border-purple-500/20 hover:border-pink-500/30 transition-all">
